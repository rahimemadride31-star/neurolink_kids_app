                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      final medReports = state.medicalReports
                          .where((r) => r.patientName == c.name)
                          .toList();
                      final lastReport = medReports.isNotEmpty
                          ? DateFormat('dd/MM/yyyy')
                              .format(medReports.first.date)
                          : '-';
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 2),
                                    Text(
                                        '${S.get('medical_reports')}: ${medReports.length} • ${S.get('recent_medical')}: $lastReport',
                                        style: const TextStyle(
                                            color: AppColors.textMuted,
                                            fontSize: 11)),
                                  ],
